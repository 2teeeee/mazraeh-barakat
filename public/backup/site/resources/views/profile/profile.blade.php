...
<div class="col-md-12 p-0">
    <div class="card">
        <div class="card-header text-center">
            ...
            <h4>
            {{ __('validation.attributes.changeInfo') }}
            </h4>
        </div>
        <div class="card-body"> 
            ...
            @endif
                ...
                <form method="POST" action="{{ route('profile/changeInfo.html') }}">
                @csrf
                                    ...
                                    <div class="col-md-12">
                                        <select name="level_tahsil" id="level_tahsil" class="form-control {{ $errors->has('level_tahsil') ? ' is-invalid' : '' }}">
                                            ...
                                            @foreach ($sathTahsil as $key => $tahsil)
                                                <option {{ (old('level_tahsil') == $key)?"selected":(($model->level_tahsil == $key)?"selected":"") }} value="{{ $key }}">{{ $tahsil }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12 row">
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="orchardist" name="role[]" value="6" {{ old("role")?(in_array(6,old("role"))?"checked":""):(Auth::user()->checkRole(6)?"checked":"") }}>
                                                <label class="form-check-label mr-4" for="orchardist">
                                                    باغ دارم.
                                                </label>
                                            </div>
                                        </div>
