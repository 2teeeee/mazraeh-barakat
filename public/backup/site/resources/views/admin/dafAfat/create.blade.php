...
<div class="col-sm-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('dafAfat/store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row" style="margin-bottom: 15px;">
                    <div class="form-group col-sm-6">
                        ...
                        <select name="type" id="user_id" class="form-control {{ $errors->has('type') ? ' is-invalid' : '' }}">
                            <option value="0">شرکت دارای مجوز</option>
                            <option value="1">شخص دارای مجوز</option>
                        </select>
                        @if ($errors->has('type'))
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="ostan" type="text" class="form-control {{ $errors->has('ostan') ? ' is-invalid' : '' }}" name="ostan" value="{{ old('ostan') }}" >
                        @if ($errors->has('ostan'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="level_nezam_mohandesi" class="col-form-label text-md-right">{{ __('validation.attributes.level_nezam_mohandesi') }}</label>
                        <input id="level_nezam_mohandesi" type="text" class="form-control {{ $errors->has('level_nezam_mohandesi') ? ' is-invalid' : '' }}" name="level_nezam_mohandesi" value="{{ old('level_nezam_mohandesi') }}" >
                        @if ($errors->has('level_nezam_mohandesi'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('level_nezam_mohandesi') }}</strong>
                            </span>
                        @endif
                    </div>
