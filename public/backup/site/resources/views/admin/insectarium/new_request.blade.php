...
<div class="col-md-12 p-0">
    <div class="card">
        <div class="card-header text-center">
            ...
            <h4>
            {{ __('validation.attributes.new_insectarium_request') }}
            </h4>
        </div>
        <div class="card-body"> 
            ...
            @endif
                ...
                <form method="POST" action="{{ route('azmayeshgah/new') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="name" class="col-form-label text-md-right">نام شرکت اینسکتاریوم</label>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="num_pkasb" class="col-form-label text-md-right">{{ __('validation.attributes.num_pkasb') }}</label>
                        <input id="tel" type="text" class="form-control {{ $errors->has('num_pkasb') ? ' is-invalid' : '' }}" name="num_pkasb" value="{{ old('num_pkasb') }}" >
                        @if ($errors->has('num_pkasb'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('num_pkasb') }}</strong>
                            </span>
                        @endif
                    </div>
                    
                    <div class="form-group col-sm-6">
                        <label for="image_pkasb" class="col-form-label text-md-right">{{ __('validation.attributes.image_pkasb') }}</label>
                        <input id="image_mojavez" type="file" class="form-control {{ $errors->has('image_pkasb') ? ' is-invalid' : '' }}" name="image_pkasb" value="{{ old('image_pkasb') }}" >
                        @if ($errors->has('image_pkasb'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('image_pkasb') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="date_start_pkasb" class="col-form-label text-md-right">{{ __('validation.attributes.date_start_pkasb') }}</label>
                        <input id="date_start_pkasb" type="text" class="form-control {{ $errors->has('date_start_pkasb') ? ' is-invalid' : '' }}" name="date_start_pkasb" value="{{ old('date_start_pkasb') }}" >
                        @if ($errors->has('date_start_pkasb'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('date_start_pkasb') }}</strong>
                            </span>
                        @endif
                    </div>
                    
                    <div class="form-group col-sm-6">
                        <label for="date_end_pkasb" class="col-form-label text-md-right">{{ __('validation.attributes.date_end_pkasb') }}</label>
                        <input id="date_end_pkasb" type="text" class="form-control {{ $errors->has('date_end_pkasb') ? ' is-invalid' : '' }}" name="date_end_pkasb" value="{{ old('date_end_pkasb') }}" >
                        @if ($errors->has('date_end_pkasb'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('date_end_pkasb') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
