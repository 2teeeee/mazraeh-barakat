            ...
            <div class="col-md-12 border py-2">
                <div class="card-body" id="text">
                    ...
                    <div>
                        ...
                        <span><strong>{{ str_replace('.','/', $model->user->keshtProduct($model->product_id,$model->abType_id,$model->ct_id)->sum) }}</strong> هکتار محصول زراعی <strong>{{ $model->product->title }} {{ $model->ab->title }}</strong> </span>
                        ...
                        شایان ذکر است مبلغ حواله فوق جهت اخذ از بهره بردار <strong>{{ number_format($model->price_all) }} ریال</strong> می باشد.
                        <br/><br/>
                        ...
                        <span>ضمنا اعتبار این حواله و مهلت زمانی تحویل کود و پرداخت وجه اعلامی در محل کارگزاری از تاریخ <strong>{{ jdate($model->make_date)->format("Y/m/d") }}</strong> به مدت 5 روز کاری می باشد. </span>
