            ...
            <form method="POST" action="{{ route('bahrebardar/update', $model->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="ostan" type="text" class="form-control {{ $errors->has('ostan') ? ' is-invalid' : '' }}" name="ostan" value="{{ old('ostan')?old('ostan'):$model->ostan }}" >
                        @if ($errors->has('ostan'))
                            <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input id="city" type="text" class="form-control {{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" value="{{ old('city')?old('city'):$model->city }}" >
                        @if ($errors->has('city'))
                            <span class="invalid-feedback" role="alert">
