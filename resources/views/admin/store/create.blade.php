            ...
            <form method="POST" action="{{ route('store/store') }}" enctype="multipart/form-data">
                ...
                <div class="row" style="margin-bottom: 15px;">
                    <div class="form-group col-sm-6">
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}">{{ $user->name." - ".$user->codemelli }}</option>
                        @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input id="utm" type="text" class="form-control {{ $errors->has('utm') ? ' is-invalid' : '' }}" name="utm" value="{{ old('utm') }}" >
                        @if ($errors->has('utm'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="date_start_mojavez" type="text" class="form-control {{ $errors->has('date_start_pkasb') ? ' is-invalid' : '' }}" name="date_start_pkasb" value="{{ old('date_start_pkasb') }}" >
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input id="date_end_mojavez" type="text" class="form-control {{ $errors->has('date_end_pkasb') ? ' is-invalid' : '' }}" name="date_end_pkasb" value="{{ old('date_end_pkasb') }}" >
