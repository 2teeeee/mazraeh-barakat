            ...
            <form method="POST" action="{{ route('user/update', $model->id) }}">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="codemelli" type="text" class="form-control {{ $errors->has('codemelli') ? ' is-invalid' : '' }}" name="codemelli" value="{{ old('codemelli')?old('codemelli'):$model->codemelli }}" autofocus>
                        ...
                        <div class="col-md-12">
                            <select name="city_id" id="kood_id" class="form-control {{ $errors->has('city_id') ? ' is-invalid' : '' }}">
                                ...
                                @foreach ($citys as $city)
                                    <option {{ (old('city_id') == $city->id)?'selected':(($model->city_id == $city->id)?'selected':'') }} value="{{ $city->id }}">{{ $city->title }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="company" type="text" class="form-control {{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" value="{{ old('company')?old('company'):$model->company }}" >
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        @foreach ($roles as $role)
                            <option {{ ($model->checkRole($role->id)?'selected':'') }} value="{{ $role->id }}">{{ $role->title }}</option>
                        @endforeach
                        </select>
                        @if ($errors->has('role'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="level_tahsil" type="text" class="form-control {{ $errors->has('level_tahsil') ? ' is-invalid' : '' }}" name="level_tahsil" value="{{ old('level_tahsil')?old('level_tahsil'):$model->level_tahsil }}" >
