            ...
            <div class="col-md-12 border py-2">
                <div class="card-body" id="text">
                    ...
                    <div>
                        ...
                        <span>ضمنا اعتبار این حواله و مهلت زمانی تحویل کود و پرداخت وجه اعلامی در محل کارگزاری از تاریخ <strong>{{ jdate($model->make_date)->format("Y/m/d") }}</strong> به مدت 40 روز کاری می باشد. </span>
