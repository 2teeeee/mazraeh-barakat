...
<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('request/sam/store') }}" enctype="multipart/form-data">
                @csrf

                {{ Form::hidden('requestType_id', $type) }}
                <div class="row" style="margin-bottom: 15px;">
                    <div class="form-group col-sm-6">
                        <label for="location" class="col-form-label text-md-right">{{ __('validation.attributes.bahrebardar') }} <i class="text-danger">*</i></label>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="kesht_type" class="col-form-label text-md-right">{{ __('validation.attributes.kesht_type') }} <i class="text-danger">*</i></label>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="mahsool_id" class="col-form-label text-md-right">{{ __('validation.attributes.mahsool_name') }} <i class="text-danger">*</i></label>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="kesht_sath" class="col-form-label text-md-right">{{ __('validation.attributes.kesht_sath') }} <i class="text-danger">*</i></label>
                        <div class="row mx-1">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="bazr_type" class="col-form-label text-md-right">{{ __('validation.attributes.bazr_type') }} <i class="text-danger">*</i></label>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="kesht_old" class="col-form-label text-md-right">{{ __('validation.attributes.kesht_old') }} <i class="text-danger">*</i></label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="ab_start_date" class="col-form-label text-md-right">{{ __('validation.attributes.ab_start_date') }} <i class="text-danger">*</i></label>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="ab_dore" class="col-form-label text-md-right">{{ __('validation.attributes.ab_dore') }} <i class="text-danger">*</i> ({{ trans('validation.attributes.day') }})</label>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="kood_type" class="col-form-label text-md-right">{{ __('validation.attributes.kood_type') }} <i class="text-danger">*</i> <span style="font-size: 12px;color:#aaaaaa;">لیست کودهایی که استفاده می کنید را وارد کنید.</span></label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="ab_ec" class="col-form-label text-md-right">{{ __('validation.attributes.ab_ec') }} <i class="text-danger">*</i></label>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="khak_ec" class="col-form-label text-md-right">{{ __('validation.attributes.khak_ec') }} <i class="text-danger">*</i></label>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="ab_type" class="col-form-label text-md-right">{{ __('validation.attributes.ab_type') }} <i class="text-danger">*</i></label>
