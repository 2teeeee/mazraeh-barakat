...
@section('content')
    ...
    <div class="card-header text-center">
        <h5>
        پیشنهاد قیمت خرید کود برای درخواست شماره ی  {{ $model->id }}
        </h5>
    </div>
    <div class="panel panel-default">
        <div class="panel-body">
            @if($model->getKood)
                ...
                <div class="row">
                    <div class="col-md-6 border border-top-0 py-2">{{ $model->getKood->sendType?$model->getKood->sendType->title:"" }}</div>
                </div>
            @endif
            <div class="row card-header">
                مزرعه
