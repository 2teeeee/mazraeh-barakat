                    ...
                    <form method="POST" action="{{ url('login.html') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 position-relative">
								...
								<div class="text-link position-absolute text-gray" onClick="showPass()" id="showPass" style="top: 5px;left: 20px;cursor: pointer">
									<i class="fas fa-2x fa-eye text-gray" style="    color: #a7a7a7;"></i>
								</div>
